...
export const mockProducts: ProductType[] = [
  ...
  },
  {
    ...
    characteristics: "Автоматическое переключение между устройствами, встроенный микрофон, быстрая зарядка."
  },
  {
    id: 12,
    ...
    characteristics: "Активное шумоподавление, автоматическая оптимизация звука, комфортная посадка."
  },
  {
    id: 13,
    ...
    characteristics: "Процессор Intel Core i7, видеокарта NVIDIA GeForce RTX 3070 Ti, высокая частота обновления экрана."
  },
  {
    id: 14,
    ...
    characteristics: "Процессор AMD Ryzen 9, видеокарта NVIDIA GeForce RTX 4090, дисплей с высокой частотой обновления."
  },
  {
    id: 15,
    ...
    characteristics: "Съемка видео 5.3K, прочный корпус, поддержка карт памяти microSD."
  },
  {
    id: 16,
  ...
  },
  {
    ...
    characteristics: "Высокая производительность, большой объем оперативной памяти, поддержка клавиатуры и стилуса."
  },
  {
    id: 18,
    ...
    characteristics: "Емкость 10000 мАч, быстрая зарядка, легкий и компактный дизайн."
  },
  {
    id: 19,
    ...
    characteristics: "Защита от воды IPX7, мощный звук, долгое время работы от батареи."
  },
  {
    id: 20,
    ...
    characteristics: "Мониторинг сердечного ритма, отслеживание сна, поддержка уведомлений."
  },
  {
    id: 21,
    title: "Xiaomi Mi Band 7 Pro",
    description: "Умный браслет Xiaomi с расширенными возможностями мониторинга активности",
    price: 7990,
    quantity: 25,
    category: "watches",
    imageUrl: "/images/21.jpg",
    characteristics: "Цветной AMOLED-дисплей, мониторинг пульса и уровня кислорода в крови, поддержка GPS."
  },
  {
    id: 22,
    ...
    characteristics: "Легкий алюминиевый корпус, высокопроизводительный процессор Intel, отличная автономность."
  },
  {
    id: 23,
    ...
    characteristics: "Bluetooth подключение, активное шумоподавление, длительный срок службы батареи."
  },
  {
    id: 24,
    ...
    characteristics: "OLED-технология, Dolby Vision и Atmos, интеллектуальная система webOS."
  },
  {
    id: 25,
    ...
    characteristics: "Матрица 45.7MP, двойная карта памяти, стабилизатор изображения."
  },
  {
    id: 26,
    ...
    characteristics: "Скорость передачи данных до 6 Гбит/с, поддержка MU-MIMO, шесть антенн."
  },
  {
    id: 27,
  ...
  },
  {
    ...
    description: "Многофункциональный принтер Epson с системой непрерывной подачи чернил",
    price: 19990,
    quantity: 12,
    category: "printers",
    imageUrl: "/images/28.jpg",
    characteristics: "Система непрерывной подачи чернил, экономичный расход, печать фото высокого качества."
  },
  {
    id: 29,
    ...
    characteristics: "Энергосберегающая технология, бесшумная работа, вместительность до 14 комплектов посуды."
  },
  {
    id: 30,
    title: "De'Longhi ECAM23460 Magnifica Coffee Machine",
    description: "Автоматическая кофемашина De'Longhi с функцией автоматического приготовления кофе",
    price: 59990,
    quantity: 10,
    category: "kitchen_appliances",
    imageUrl: "/images/30.jpg",
    characteristics: "Автоматический капучинатор, настройка крепости напитка, возможность программирования рецептов."
  },
  {
    id: 31,
    title: "MSI Creator 17 Studio Edition Laptop",
    description: "Ноутбук MSI для профессиональных дизайнеров и творческих специалистов",
    price: 229990,
    quantity: 5,
    category: "laptops",
    imageUrl: "/images/31.jpg",
    characteristics: "Процессор Intel Core i9, графический ускоритель NVIDIA Quadro RTX 5000, экран Pantone Validated."
  },
  {
    id: 32,
    ...
    characteristics: "Открытого типа, высокое качество звучания, долговечность конструкции."
  },
  {
    id: 33,
    title: "HTC Vive Cosmos Elite VR Headset",
    description: "VR-шлем HTC с высококачественным дисплеем и интуитивным управлением",
    price: 79990,
    quantity: 8,
    category: "vr",
    imageUrl: "/images/33.jpg",
    characteristics: "Разрешение дисплея 2880x1700 пикселей, контроллеры с обратной связью, поддержка SteamVR."
  },
  {
    id: 34,
    ...
    characteristics: "Эффективная очистка воздуха, регулируемый поток воздуха, таймер отключения."
  },
  {
    id: 35,
    title: "Seagate BarraCuda Q Hybrid Solid State Drive",
    description: "Гибридный твердотельный накопитель Seagate с высокой скоростью чтения",
    price: 12990,
    quantity: 20,
    category: "storage",
    imageUrl: "/images/35.jpg",
    characteristics: "Объем 2 ТБ, скорость чтения до 540 МБ/с, интерфейс SATA III."
  },
  {
    id: 36,
    title: "Panasonic Lumix DC-G100 Compact Camera",
    description: "Компактная цифровая камера Panasonic с сенсором Micro Four Thirds",
    price: 69990,
    quantity: 12,
    category: "cameras",
    imageUrl: "/images/36.jpg",
    characteristics: "Сенсор Micro Four Thirds, запись видео 4K, поворотный сенсорный экран."
  },
  {
    id: 37,
    ...
    characteristics: "Объем хранилища 4 TB, доступ к файлам удаленно, простое управление."
  },
  {
    id: 38,
    title: "Acer Predator Helios 300 Gaming Laptop",
    description: "Игровой ноутбук Acer с отличной графикой и производительностью",
    price: 119990,
    quantity: 7,
    category: "laptops",
    imageUrl: "/images/38.jpg",
    characteristics: "Графика NVIDIA GeForce RTX 3060, IPS-дисплей с частотой 144 Гц, подсветка RGB."
  },
  {
    id: 39,
    ...
    characteristics: "Совместимость с Alexa, поддержка DTS Virtual:X, простая установка."
  },
  {
    id: 40,
    title: "Belkin Boost Charge Pro MagSafe Charging Dock",
    description: "Зарядная станция Belkin с поддержкой MagSafe для устройств Apple",
    price: 14990,
    quantity: 20,
    category: "accessories",
    imageUrl: "/images/40.jpg",
    characteristics: "Одновременная зарядка смартфона и часов, быстрое заряжание MagSafe."
  }
